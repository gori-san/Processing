...
void drawLight(){
  spotLight(255, 0, 0, -r*cos(theta), 1200, -r*sin(theta), 0, -1, 0, PI / 4, 40);
  spotLight(0, 255, 0, -r*cos(theta+2*PI/3), 1200, -r*sin(theta+2*PI/3), 0, -1, 0, PI / 4, 40);
  spotLight(0, 0, 255, -r*cos(theta+4*PI/3), 1200, -r*sin(theta+4*PI/3), 0, -1, 0, PI / 4, 40);
  theta+=0.1; 
}
